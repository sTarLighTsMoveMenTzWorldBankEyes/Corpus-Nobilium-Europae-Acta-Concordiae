...
export const housesGlobal: House[] = [
  {
    "id": "yamato",
    "name": "Yamato",
    "altNames": [
  ...
  {
    "id": "borjigin-dschingis-khan-clan",
  ...
  {
    "id": "solomonische-dynastie-athiopien",
  ...
  {
    "id": "brasilianische-kaiserfamilie-orleans-braganca",
  ...
  {
    "id": "mexikanisches-kaiserhaus-iturbide",
    "name": "Mexikanisches Kaiserhaus (Iturbide)",
    "altNames": [
      "Mexican Imperial House (Iturbide)",
      "Casa de Iturbide",
  ...
  {
    "id": "hawaiian-royal-family-kamehameha",
  ...
  {
    "id": "maori-king-movement-kingitanga",
  ...
  {
    "id": "eswatini-royal-family-dlamini",
  ...
  {
    "id": "lesotho-royal-family-seeiso",
    "name": "Lesotho Royal Family (Seeiso)",
    "altNames": [
      "House of Moshoeshoe",
      "Basotho Royal Family",
      "Seeiso Dynasty"
    ],
    "region": "Weltweit (Asien, Afrika, Amerika, Naher Osten)",
    "country": "Lesotho",
  ...
  {
    "id": "alaouite-dynasty-marokko",
    "name": "Alaouite Dynasty (Marokko)",
    "altNames": [
      "Alawi Dynasty",
      "'Alawid Dynasty",
      "Sharifian Dynasty of Morocco",
  ...
  {
    "id": "inka-kaiserdynastie-sapa-inka",
    "name": "Inka-Kaiserdynastie (Sapa Inka)",
    "altNames": [
      "Inca Dynasty",
      "House of Manco Cápac",
      "Inca Imperial Dynasty",
      "Tawantinsuyu Dynasty"
    ],
    "region": "Weltweit (Asien, Afrika, Amerika, Naher Osten)",
    "country": "Peru",
    "type": "Kaiser- & Königshaus",
  ...
  {
    "id": "aztekische-kaiserdynastie-tenochtitlan",
  ...
  {
    "id": "maya-dynastie-von-palenque-b-aakal",
    "name": "Maya-Dynastie von Palenque (B'aakal)",
    "altNames": [
      "Maya Dynasty of Palenque",
      "House of Pakal",
      "Dynasty of Palenque",
      "B'aakal Dynasty"
    ],
  ...
  {
    "id": "maya-dynastie-von-tikal-mutul",
    "name": "Maya-Dynastie von Tikal (Mutul)",
    "altNames": [
      "Maya Dynasty of Tikal",
      "House of Tikal",
      "Mutul Dynasty"
    ],
    "region": "Weltweit (Asien, Afrika, Amerika, Naher Osten)",
